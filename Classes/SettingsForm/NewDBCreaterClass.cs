...
namespace Enterprise_Managment_IS.Classes.SettingsForm
{
    ...
    {
        const string createProcedureQuery = "CREATE PROCEDURE CreateEMISTables AS " +
            "BEGIN " +
        ...
        const string execProcedure = "EXEC CreateEMISTables";
        ...
        public static void expandAllTablesInTheNewDatabase(string connectionString)
        {
            ...
            try
            {                
                string query = createProcedureQuery;
                sqlConnection.Open();
