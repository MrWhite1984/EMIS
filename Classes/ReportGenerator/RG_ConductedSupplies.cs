...
{
    class RG_ConductedSupplies
    {
        public async static Task<string> GenerateReport(string path)
        {
            List<string[]> result = DataLoader_ConductedSupplies.GetAllConductedSupplies();
            ...
            doc.Tables[1].Rows[1].Range.Text = $"Список проведенных поставок на {DateTime.Now}\n";
