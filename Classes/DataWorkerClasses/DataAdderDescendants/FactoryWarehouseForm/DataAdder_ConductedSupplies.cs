...
{
    class DataAdder_ConductedSupplies
    {
        public static void AddNewConductedSuppliesToDB(Supply supply)
        {
        ...
        public static void AddNewConductedSuppliesToDB(Supply supply, string conStr)
        {
